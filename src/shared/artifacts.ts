...
import {
	...
	projectHash,
	resolveProjectStore,
	LEGACY_PROJECT_SUBAGENTS_RELATIVE_DIR,
} from "./project-store.ts";
import { cleanupOrphanedSessionDirs } from "./session-housekeeping.ts";
...
/** Back-compat alias for callers that pre-date the storage-centralization rename. */
